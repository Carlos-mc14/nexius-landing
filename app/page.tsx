...
import { getFeaturedPromotions } from "@/lib/promotions" // Added promotions import
import { formatDate } from "@/lib/utils"
import { getSeoConfig } from "@/lib/seo"
import { PromotionCard } from "@/components/promotion-card" // Added promotion card import
...
export default async function Home() {
  ...
  return (
    <>
      {/* JSON-LD Schema generated from central SEO config */}
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: buildSiteJsonLd(seoConfig, homepageContent) }} />
          ...
          >
            <div className="container px-4 md:px-6">
              <div className="flex flex-col items-center justify-center space-y-4 text-center mb-12">
                <div className="text-slate-700 inline-flex items-center rounded-full border border-yellow-500/20 bg-yellow-500/10 px-3 py-1 text-sm backdrop-blur-sm dark:border-yellow-400/30 dark:bg-yellow-400/20 dark:text-slate-200">
                  <span className="font-medium">Ofertas Especiales</span>
                </div>
                <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl">Promociones Destacadas</h2>
                <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed">
                  Aprovecha nuestras ofertas exclusivas por tiempo limitado. Servicios de calidad con descuentos
                  especiales.
                </p>
              </div>
